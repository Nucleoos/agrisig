...
function CodeInParametrage(){
    ...
    AllIt.IncludeJs("gestsea_parametrage_plus.js");
    ...
    It_Typelien.AjouterComposantSimple("Description", "tl_description");
    ...
    */
    ...
    It_Produit.AjouterComposantSimple("Libellé","pd_libelle");
    ...
    AllIt.GenererInterface("gestsea_parametrage",null,"GestSEA Paramétrage");
