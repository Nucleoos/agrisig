...
//    principal_alert("Début de la construction 2");
    ...
    */
    ...
    PersonneContact.AjouterColonne("Coordonnées","cn_coordonnee");
    // Filtre perso
    ...
    */
    ...
    PersonneEstjoignable.AjouterColonne("Coordonnées","cn_coordonnee",new Array("cn_numero","cn_numero","contact"));
    ...
    */
    ...
    PersonneEstjoignableContact = It_Personne.AjouterComposantSimple("Coordonnée","cn_coordonnee",new Array("cn_numero","cn_numero","contact"),PersonneEstjoignable,LISTE_DEROULANTE);
    ...
    // Filtre perso (on filtre les Catégories par rapportx au types d'attributs)
   ...
   //    It_Reglement.AjouterComposantSimple("N° Facture (Si le règlement correspond)","fa_numfact",new Array("fa_numero","fa_numero","facture"),null,LISTE_DEROULANTE);
    ...
    It_Reglement.AjouterComposantSimple("Libellé de la banque","rg_libellebanque");
