...
var Slave_0_de_Slave_8_de_Racine=new clAttribut("cont_coordonnees","contact",null);


	/* Ce composant représente: contact.cont_coordonnees sous le nom "Coordonnées" */
var Compo_Slave_0_de_Slave_8_de_Racine=new clCompoTextBox(Slave_0_de_Slave_8_de_Racine,null,"Coordonnées");
var Slave_8_de_Racine=new clEnsembleAttributs("contact",
	...
	new Array(
	new clLiaison(null,Slave_0_de_Slave_8_de_Racine)
	));

var Titre_Slave_8_de_Racine=new Array("Type","Coordonnées");

var FiltrePersoSurPerso=new clInterfaceFiltrageCustom("Personnel","cont_type='personnel'");
var FiltrePersoSurPortable=new clInterfaceFiltrageCustom("Portable","cont_type='portable'");
var FiltrePersoSurFax=new clInterfaceFiltrageCustom("Fax","cont_type='fax'");
	/* Ce composant représente: des éléments de la table contact sous le nom "Contact de la personne" */
var Compo_Slave_8_de_Racine=new clCompoListe(Slave_8_de_Racine,new Array(FiltrePersoSurFax,FiltrePersoSurPortable,FiltrePersoSurPerso),Titre_Slave_8_de_Racine,"Contact de la personne",true);

FiltrePersoSurPerso.setComposant(Compo_Slave_8_de_Racine);
FiltrePersoSurPortable.setComposant(Compo_Slave_8_de_Racine);
FiltrePersoSurFax.setComposant(Compo_Slave_8_de_Racine);

Compo_Slave_0_de_Slave_8_de_Racine.GenererXUL(top.document.getElementById("1_Slaves"));
...
Compo_Slave_6_de_Racine.GenererXUL(top.document.getElementById("0_Slaves"));
Compo_Slave_7_de_Racine.GenererXUL(top.document.getElementById("0_Slaves"));
