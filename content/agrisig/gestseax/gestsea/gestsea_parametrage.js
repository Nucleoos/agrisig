...
var Col_N0_Nom_De_Accès_Liste_des_niveaux_d_accès0=new clAttribut("ac_libelle","acces",null);

var Col_N1_Niveau_De_Accès_Liste_des_niveaux_d_accès0=new clAttribut("ac_niveau","acces",null);
...
var Accès_Liste_des_niveaux_d_accès0=new clEnsembleAttributs("acces",
	new Array(
	new clLiaison(null,Col_N0_Nom_De_Accès_Liste_des_niveaux_d_accès0)
	,new clLiaison(null,Col_N1_Niveau_De_Accès_Liste_des_niveaux_d_accès0)
	),
	new Array(
...
var Titre_Accès_Liste_des_niveaux_d_accès0=new Array("Nom","Niveau");
...
top.TAB_GLOBAL_COMPO[3]=Compo_Accès_Liste_des_niveaux_d_accès0;
...
top.TAB_GLOBAL_COMPO[6]=Compo_Accès_Nom_1;
...
top.TAB_GLOBAL_COMPO[7]=Compo_Accès_Niveau_2;
...
var Col_N2_Quantité_De_Adhérence_Liste_des_adhérences0=new clAttribut("ah_quantite","adherence",null);
...
var Adhérence_Quantité_4=new clAttribut("ah_quantite","adherence",null);


	/* Ce composant représente: adherence.ah_quantite sous le nom "Quantité" */
var Compo_Adhérence_Quantité_4=new clCompoTextBox(Adhérence_Quantité_4,null,"Quantité",false,false);
var Col_N0_Du_De_Adhérence_Périodes_de_validité_6=new clAttribut("po_debut","periode",null);

var Col_N1_au_De_Adhérence_Périodes_de_validité_6=new clAttribut("po_fin","periode",null);

var Adhérence_Périodes_de_validité_6=new clEnsembleAttributs("periode",
	new Array(
	new clLiaison(null,Col_N0_Du_De_Adhérence_Périodes_de_validité_6)
	,new clLiaison(null,Col_N1_au_De_Adhérence_Périodes_de_validité_6)
	),
	null);

var Titre_Adhérence_Périodes_de_validité_6=new Array("Du","au");

	/* Ce composant représente: des éléments de la table periode sous le nom "Périodes de validité" */
var Compo_Adhérence_Périodes_de_validité_6=new clCompoListe(Adhérence_Périodes_de_validité_6,null,Titre_Adhérence_Périodes_de_validité_6,"Périodes de validité",true,true);
var Joint_Esclave_Adhérence_Périodes_de_validité_6=new clJointureMulti("adherence",
	new Array(
...
var Adhérence_Liste_des_adhérences0=new clEnsembleAttributs("adherence",
	...
	,new clLiaison(null,Col_N2_Quantité_De_Adhérence_Liste_des_adhérences0)
	),
	new Array(
	...
	,new clLiaison(null,Adhérence_Quantité_4)
	,new clLiaison(Joint_Esclave_Adhérence_Périodes_de_validité_6,Adhérence_Périodes_de_validité_6)
	));

var Titre_Adhérence_Liste_des_adhérences0=new Array("Libellé","Réduction","Quantité");
...
var Col_N0_Du_De_Adhérence_Indpt_Périodes_disponibles_5=new clAttribut("po_debut","periode",null);

var Col_N1_au_De_Adhérence_Indpt_Périodes_disponibles_5=new clAttribut("po_fin","periode",null);

var Adhérence_Indpt_Périodes_disponibles_5=new clEnsembleAttributs("periode",
	new Array(
	new clLiaison(null,Col_N0_Du_De_Adhérence_Indpt_Périodes_disponibles_5)
	,new clLiaison(null,Col_N1_au_De_Adhérence_Indpt_Périodes_disponibles_5)
	),
	null);

var Titre_Adhérence_Indpt_Périodes_disponibles_5=new Array("Du","au");

	/* Ce composant représente: des éléments de la table periode sous le nom "Périodes disponibles" */
var Compo_Adhérence_Indpt_Périodes_disponibles_5=new clCompoListe(Adhérence_Indpt_Périodes_disponibles_5,new Array(new clInterfaceFiltrageVide(),Filtre_Dep_Périodes_0=new clInterfaceFiltrageRelationOnglet("Périodes",Gerer_Périodes,OuvrirOnglet_Adhérence)),Titre_Adhérence_Indpt_Périodes_disponibles_5,"Périodes disponibles",true,true);
...
top.TAB_GLOBAL_COMPO[180]=Compo_Adhérence_Liste_des_adhérences0;
...
top.TAB_GLOBAL_COMPO[184]=Compo_Adhérence_Produit_1;
...
top.TAB_GLOBAL_COMPO[185]=Compo_Adhérence_Libellé_2;
...
top.TAB_GLOBAL_COMPO[186]=Compo_Adhérence_Réduction_3;

	/* Ce composant représente: des éléments de la table adherence sous le nom "Quantité" */
 if(ALeDroit(0,"adherence"))
 {
Compo_Adhérence_Quantité_4.GenererXUL(top.document.getElementById("Adhérence_Liste_des_adhérences0_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 187*/
top.TAB_GLOBAL_COMPO[187]=Compo_Adhérence_Quantité_4;

	/* Ce composant représente: periode.undefined sous le nom "Périodes disponibles" */
 if(ALeDroit(0,"periode"))
 {
Compo_Adhérence_Indpt_Périodes_disponibles_5.GenererXUL(top.document.getElementById("ListeDessus_Adhérence_Périodes_de_validité_6"));

 }

	/* On l'ajoute au tableau global à l'indice 188*/
top.TAB_GLOBAL_COMPO[188]=Compo_Adhérence_Indpt_Périodes_disponibles_5;

	/* Ce composant représente: periode.undefined sous le nom "Périodes de validité" */
 if(ALeDroit(0,"periode"))
 {
Compo_Adhérence_Périodes_de_validité_6.GenererXUL(top.document.getElementById("Adhérence_Périodes_de_validité_6"));

 }

	/* On l'ajoute au tableau global à l'indice 191*/
top.TAB_GLOBAL_COMPO[191]=Compo_Adhérence_Périodes_de_validité_6;
...
top.TAB_GLOBAL_COMPO[111]=Compo_Agents_Prénom_2;
...
top.TAB_GLOBAL_COMPO[113]=Compo_Agents_En_activité_4;
...
top.TAB_GLOBAL_COMPO[114]=Compo_Agents_Rôle_5;
...
top.TAB_GLOBAL_COMPO[115]=Compo_Agents_Équipe_6;
...
top.TAB_GLOBAL_COMPO[116]=Compo_Agents_Téléphone_professionnel_7;
...
top.TAB_GLOBAL_COMPO[117]=Compo_Agents_Téléphone_portable_8;
...
var Col_N0_Nom_De_Codes_postaux_Villes_liées_au_code_postal_4=new clAttribut("vi_nom","ville",null);

var Codes_postaux_Villes_liées_au_code_postal_4=new clEnsembleAttributs("ville",
	new Array(
	new clLiaison(null,Col_N0_Nom_De_Codes_postaux_Villes_liées_au_code_postal_4)
	),
	null);

var Titre_Codes_postaux_Villes_liées_au_code_postal_4=new Array("Nom");
...
top.TAB_GLOBAL_COMPO[135]=Compo_Codes_postaux_Villes_liées_au_code_postal_4;
...
top.TAB_GLOBAL_COMPO[90]=Compo_Profils_de_droits_Libellé_1;
...
Compo_Profils_de_droits_Lecture_4.GenererXUL(top.document.getElementById("Profils_de_droits_Droits_2_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 95*/
...
var Employés_Emploi_5=new clAttribut("em_emploi","employe",null);


	/* Ce composant représente: employe.em_emploi sous le nom "Emploi" */
var Compo_Employés_Emploi_5=new clCompoTextBox(Employés_Emploi_5,null,"Emploi",false,false);
var Employés_Accès_comptabilité_6=new clAttribut("ac_nom","acces",null);


	/* Ce composant représente: acces.ac_nom sous le nom "Accès comptabilité" */
var Compo_Employés_Accès_comptabilité_6=new clCompoListeDeroulanteSimple(Employés_Accès_comptabilité_6,new Array(clCompoListeDeroulanteSimple.prototype.FiltreParDefaut(),Filtre_Dep_Accès_0=new clInterfaceFiltrageRelationOnglet("Accès",Gerer_Accès,OuvrirOnglet_Employés)),"Accès comptabilité");
var Joint_Esclave_Employés_Accès_comptabilité_6=new clJointureMulti("employe",
	new Array(
	new stJointure("acces","em_acces","ac_numero",null,false)
	));
var Employés_Profil_de_droits_7=new clAttribut("dp_libelle","droitprofil",null);


	/* Ce composant représente: droitprofil.dp_libelle sous le nom "Profil de droits" */
var Compo_Employés_Profil_de_droits_7=new clCompoListeDeroulanteSimple(Employés_Profil_de_droits_7,new Array(clCompoListeDeroulanteSimple.prototype.FiltreParDefaut(),Filtre_Dep_Profils_de_droits_0=new clInterfaceFiltrageRelationOnglet("Profils de droits",Gerer_Profils_de_droits,OuvrirOnglet_Employés)),"Profil de droits");
var Joint_Esclave_Employés_Profil_de_droits_7=new clJointureMulti("employe",
	new Array(
...
var Employés_Liste_des_employés0=new clEnsembleAttributs("employe",
	...
	,new clLiaison(null,Employés_Emploi_5)
	,new clLiaison(Joint_Esclave_Employés_Accès_comptabilité_6,Employés_Accès_comptabilité_6)
	,new clLiaison(Joint_Esclave_Employés_Profil_de_droits_7,Employés_Profil_de_droits_7)
	));
...
top.TAB_GLOBAL_COMPO[77]=Compo_Employés_Liste_des_employés0;
...
top.TAB_GLOBAL_COMPO[81]=Compo_Employés_Agent_1;
...
top.TAB_GLOBAL_COMPO[82]=Compo_Employés_Login_2;
...
top.TAB_GLOBAL_COMPO[83]=Compo_Employés_Mot_de_passe_3;
...
top.TAB_GLOBAL_COMPO[84]=Compo_Employés_Administrateur__Peut_créer_d_autres_utilisateurs__4;

	/* Ce composant représente: des éléments de la table employe sous le nom "Emploi" */
 if(ALeDroit(0,"employe"))
 {
Compo_Employés_Emploi_5.GenererXUL(top.document.getElementById("Employés_Liste_des_employés0_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 85*/
top.TAB_GLOBAL_COMPO[85]=Compo_Employés_Emploi_5;

	/* Ce composant représente: des éléments de la table acces sous le nom "Accès comptabilité" */
 if(ALeDroit(0,"acces"))
 {
Compo_Employés_Accès_comptabilité_6.GenererXUL(top.document.getElementById("Employés_Liste_des_employés0_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 86*/
top.TAB_GLOBAL_COMPO[86]=Compo_Employés_Accès_comptabilité_6;

	/* Ce composant représente: des éléments de la table droitprofil sous le nom "Profil de droits" */
 if(ALeDroit(0,"droitprofil"))
 {
Compo_Employés_Profil_de_droits_7.GenererXUL(top.document.getElementById("Employés_Liste_des_employés0_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 87*/
top.TAB_GLOBAL_COMPO[87]=Compo_Employés_Profil_de_droits_7;
...
top.TAB_GLOBAL_COMPO[120]=Compo_Équipes_Liste_des_équipes0;
...
top.TAB_GLOBAL_COMPO[122]=Compo_Équipes_Nom_1;
...
top.TAB_GLOBAL_COMPO[50]=Compo_Etats_de_personne_Liste_des_états_de_personne0;
...
top.TAB_GLOBAL_COMPO[52]=Compo_Etats_de_personne_Libellé_1;
...
top.TAB_GLOBAL_COMPO[102]=Compo_Groupe_de_tables_Libellé_1;
...
var Col_N0_Libellé_De_Groupes_de_cantons_Liste_des_groupes_de_cantons0=new clAttribut("gc_nom","groupecanton",null);
...
var Groupes_de_cantons_Liste_des_groupes_de_cantons0=new clEnsembleAttributs("groupecanton",
	new Array(
	new clLiaison(null,Col_N0_Libellé_De_Groupes_de_cantons_Liste_des_groupes_de_cantons0)
	),
	new Array(
...
var Titre_Groupes_de_cantons_Liste_des_groupes_de_cantons0=new Array("Libellé");
...
top.TAB_GLOBAL_COMPO[37]=Compo_Groupes_de_cantons_Libellé_1;
...
var Col_N0_Libellé_De_Modèles_d_impressions_Liste_des_modèles_d_impressions0=new clAttribut("im_libelle","impression",null);
...
var Modèles_d_impressions_Liste_des_modèles_d_impressions0=new clEnsembleAttributs("impression",
	new Array(
	new clLiaison(null,Col_N0_Libellé_De_Modèles_d_impressions_Liste_des_modèles_d_impressions0)
	),
	new Array(
...
var Titre_Modèles_d_impressions_Liste_des_modèles_d_impressions0=new Array("Libellé");
...
top.TAB_GLOBAL_COMPO[217]=Compo_Modèles_d_impressions_Liste_des_modèles_d_impressions0;
...
top.TAB_GLOBAL_COMPO[219]=Compo_Modèles_d_impressions_Libellé_1;
...
top.TAB_GLOBAL_COMPO[220]=Compo_Modèles_d_impressions_Nom_logique_2;
...
top.TAB_GLOBAL_COMPO[221]=Compo_Modèles_d_impressions_Modèle_3;
...
top.TAB_GLOBAL_COMPO[222]=Compo_Modèles_d_impressions_Modèle_utilisé_par_défaut_4;
...
top.TAB_GLOBAL_COMPO[223]=Compo_Modèles_d_impressions_Table_utilisée_5;
...
top.TAB_GLOBAL_COMPO[224]=Compo_Modèles_d_impressions_Sa_clé_6;
...
top.TAB_GLOBAL_COMPO[225]=Compo_Modèles_d_impressions_Son_champs_date_7;
...
top.TAB_GLOBAL_COMPO[226]=Compo_Impressions_Liste_des_modèles_d_impressions0;
...
top.TAB_GLOBAL_COMPO[229]=Compo_Impressions_Société_1;
...
top.TAB_GLOBAL_COMPO[230]=Compo_Impressions_Libellé_2;
...
top.TAB_GLOBAL_COMPO[232]=Compo_Impressions_Modèle_4;
...
top.TAB_GLOBAL_COMPO[233]=Compo_Impressions_Modèle_utilisé_par_défaut_5;
...
top.TAB_GLOBAL_COMPO[234]=Compo_Impressions_Table_utilisée_6;
...
top.TAB_GLOBAL_COMPO[235]=Compo_Impressions_Sa_clé_7;
...
top.TAB_GLOBAL_COMPO[205]=Compo_Modèles_Liste_des_modèles0;
...
top.TAB_GLOBAL_COMPO[207]=Compo_Modèles_Libellé_1;
...
top.TAB_GLOBAL_COMPO[208]=Compo_Modèles_Lignes_du_modèle_2;
...
top.TAB_GLOBAL_COMPO[213]=Compo_Modèles_Produit_3;
...
top.TAB_GLOBAL_COMPO[214]=Compo_Modèles_Montant_HT_4;
...
top.TAB_GLOBAL_COMPO[215]=Compo_Modèles_Montant_TTC_5;
...
top.TAB_GLOBAL_COMPO[216]=Compo_Modèles_Quantité_6;
var Col_N0_Libellé_De_Mode_de_réglements_Liste_des_modes_de_réglement0=new clAttribut("mr_libelle","modereglement",null);

var Col_N1_N_Compte_De_Mode_de_réglements_Liste_des_modes_de_réglement0=new clAttribut("cg_numcompte","comptegen",null);

var Joint_Col_N1_N_Compte_De_Mode_de_réglements_Liste_des_modes_de_réglement0=new clJointureMulti("modereglement",
	new Array(
...
var Mode_de_réglements_Compte_général_2=new clAttribut("cg_numcompte","comptegen",null);


	/* Ce composant représente: comptegen.cg_numcompte sous le nom "Compte général" */
var Compo_Mode_de_réglements_Compte_général_2=new clCompoListeDeroulanteSimple(Mode_de_réglements_Compte_général_2,null,"Compte général");
var Joint_Esclave_Mode_de_réglements_Compte_général_2=new clJointureMulti("modereglement",
	new Array(
	new stJointure("comptegen","cg_numero","cg_numero",null,false)
	));
var Mode_de_réglements_Actif_3=new clAttribut("mr_actif","modereglement",null);


	/* Ce composant représente: modereglement.mr_actif sous le nom "Actif" */
var Compo_Mode_de_réglements_Actif_3=new clCompoCheckBox(Mode_de_réglements_Actif_3,null,"Actif");
var Mode_de_réglements_Description_4=new clAttribut("mr_description","modereglement",null);


	/* Ce composant représente: modereglement.mr_description sous le nom "Description" */
var Compo_Mode_de_réglements_Description_4=new clCompoTextBox(Mode_de_réglements_Description_4,null,"Description",false,true);
var Mode_de_réglements_Liste_des_modes_de_réglement0=new clEnsembleAttributs("modereglement",
	new Array(
	new clLiaison(null,Col_N0_Libellé_De_Mode_de_réglements_Liste_des_modes_de_réglement0)
	,new clLiaison(Joint_Col_N1_N_Compte_De_Mode_de_réglements_Liste_des_modes_de_réglement0,Col_N1_N_Compte_De_Mode_de_réglements_Liste_des_modes_de_réglement0)
	),
	new Array(
	new clLiaison(null,Mode_de_réglements_Libellé_1)
	,new clLiaison(Joint_Esclave_Mode_de_réglements_Compte_général_2,Mode_de_réglements_Compte_général_2)
	,new clLiaison(null,Mode_de_réglements_Actif_3)
	,new clLiaison(null,Mode_de_réglements_Description_4)
	));

var Titre_Mode_de_réglements_Liste_des_modes_de_réglement0=new Array("Libellé","N°Compte");
...
top.TAB_GLOBAL_COMPO[8]=Compo_Mode_de_réglements_Liste_des_modes_de_réglement0;
...
top.TAB_GLOBAL_COMPO[11]=Compo_Mode_de_réglements_Libellé_1;

	/* Ce composant représente: des éléments de la table comptegen sous le nom "Compte général" */
 if(ALeDroit(0,"comptegen"))
 {
Compo_Mode_de_réglements_Compte_général_2.GenererXUL(top.document.getElementById("Mode_de_réglements_Liste_des_modes_de_réglement0_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 12*/
top.TAB_GLOBAL_COMPO[12]=Compo_Mode_de_réglements_Compte_général_2;

	/* Ce composant représente: des éléments de la table modereglement sous le nom "Actif" */
 if(ALeDroit(0,"modereglement"))
 {
Compo_Mode_de_réglements_Actif_3.GenererXUL(top.document.getElementById("Mode_de_réglements_Liste_des_modes_de_réglement0_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 13*/
top.TAB_GLOBAL_COMPO[13]=Compo_Mode_de_réglements_Actif_3;

	/* Ce composant représente: des éléments de la table modereglement sous le nom "Description" */
 if(ALeDroit(0,"modereglement"))
 {
Compo_Mode_de_réglements_Description_4.GenererXUL(top.document.getElementById("Mode_de_réglements_Liste_des_modes_de_réglement0_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 14*/
top.TAB_GLOBAL_COMPO[14]=Compo_Mode_de_réglements_Description_4;
...
top.TAB_GLOBAL_COMPO[15]=Compo_Modes_de_répartition_Liste_des_modes_de_répartition0;
...
top.TAB_GLOBAL_COMPO[19]=Compo_Modes_de_répartition_Libellé_1;
...
top.TAB_GLOBAL_COMPO[20]=Compo_Modes_de_répartition_Compte_général_2;
...
top.TAB_GLOBAL_COMPO[21]=Compo_Modes_de_répartition_Actif_3;
...
top.TAB_GLOBAL_COMPO[22]=Compo_Modes_de_répartition_Société_visée_4;
...
top.TAB_GLOBAL_COMPO[23]=Compo_Modes_de_répartition_Description_5;
var Col_N0_Du_De_Périodes_Liste_des_périodes0=new clAttribut("po_debut","periode",null);

var Col_N1_Au_De_Périodes_Liste_des_périodes0=new clAttribut("po_fin","periode",null);
...
var Périodes_Liste_des_périodes0=new clEnsembleAttributs("periode",
	new Array(
	new clLiaison(null,Col_N0_Du_De_Périodes_Liste_des_périodes0)
	,new clLiaison(null,Col_N1_Au_De_Périodes_Liste_des_périodes0)
	),
	new Array(
...
var Titre_Périodes_Liste_des_périodes0=new Array("Du","Au");
...
top.TAB_GLOBAL_COMPO[194]=Compo_Périodes_Liste_des_périodes0;
...
top.TAB_GLOBAL_COMPO[197]=Compo_Périodes_Du_1;
...
top.TAB_GLOBAL_COMPO[198]=Compo_Périodes_Au_2;
...
top.TAB_GLOBAL_COMPO[202]=Compo_Préfixes_Liste_des_préfixes0;
...
top.TAB_GLOBAL_COMPO[204]=Compo_Préfixes_Nom_1;
...
var Produits_Libellé_1=new clAttribut("pd_libelle","produit",null);


	/* Ce composant représente: produit.pd_libelle sous le nom "Libellé" */
var Compo_Produits_Libellé_1=new clCompoTextBox(Produits_Libellé_1,null,"Libellé",false,false);
...
var Produits_Soumis_à_de_potentielles_réductions_4=new clAttribut("pd_reduction","produit",null);


	/* Ce composant représente: produit.pd_reduction sous le nom "Soumis à de potentielles réductions" */
var Compo_Produits_Soumis_à_de_potentielles_réductions_4=new clCompoCheckBox(Produits_Soumis_à_de_potentielles_réductions_4,null,"Soumis à de potentielles réductions");
...
var Produits_Date_d_application_9=new clAttribut("px_datedebut","prix",null);
	...
	/* Ce composant représente: prix.px_datedebut sous le nom "Date d'application" */
...
var Produits_Actif_10=new clAttribut("px_actif","prix",null);
	...
	/* Ce composant représente: prix.px_actif sous le nom "Actif" */
...
top.TAB_GLOBAL_COMPO[158]=Compo_Produits_Liste_des_produits0;
	...
	/* Ce composant représente: des éléments de la table produit sous le nom "Libellé" */
 if(ALeDroit(0,"produit"))
 {
Compo_Produits_Libellé_1.GenererXUL(top.document.getElementById("Produits_Liste_des_produits0_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 161*/
top.TAB_GLOBAL_COMPO[161]=Compo_Produits_Libellé_1;
...
top.TAB_GLOBAL_COMPO[163]=Compo_Produits_Actif_3;
 ...
 if(ALeDroit(0,"produit"))
 {
Compo_Produits_Soumis_à_de_potentielles_réductions_4.GenererXUL(top.document.getElementById("Produits_Liste_des_produits0_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 164*/
top.TAB_GLOBAL_COMPO[164]=Compo_Produits_Soumis_à_de_potentielles_réductions_4;
...
top.TAB_GLOBAL_COMPO[172]=Compo_Produits_T_V_A__8;
	...
	/* Ce composant représente: des éléments de la table prix sous le nom "Date d'application" */
 if(ALeDroit(0,"prix"))
 {
...
top.TAB_GLOBAL_COMPO[173]=Compo_Produits_Date_d_application_9;
	...
	/* Ce composant représente: des éléments de la table prix sous le nom "Actif" */
 if(ALeDroit(0,"prix"))
 {
...
top.TAB_GLOBAL_COMPO[175]=Compo_Produits_Comptes_généraux_11;
...
top.TAB_GLOBAL_COMPO[143]=Compo_Responsabilités_Responsabilités0;
...
top.TAB_GLOBAL_COMPO[147]=Compo_Responsabilités_Code_1;
...
top.TAB_GLOBAL_COMPO[148]=Compo_Responsabilités_Nom_2;
...
top.TAB_GLOBAL_COMPO[149]=Compo_Responsabilités_Famille_3;
...
top.TAB_GLOBAL_COMPO[73]=Compo_Services_Employés_3;
...
top.TAB_GLOBAL_COMPO[56]=Compo_Sociétés_Liste_des_sociétés0;
...
top.TAB_GLOBAL_COMPO[59]=Compo_Sociétés_Type_1;
...
top.TAB_GLOBAL_COMPO[60]=Compo_Sociétés_Nom_2;
...
top.TAB_GLOBAL_COMPO[61]=Compo_Sociétés_Abbrev_3;
...
top.TAB_GLOBAL_COMPO[62]=Compo_Sociétés_Personne_4;
...
top.TAB_GLOBAL_COMPO[63]=Compo_Sociétés_Détails_5;
...
top.TAB_GLOBAL_COMPO[64]=Compo_Sociétés_Services_6;
...
top.TAB_GLOBAL_COMPO[156]=Compo_TVA_Compte_général_3;
...
var Col_N0_Libellé_De_Types_d_attribut_Liste_des_types_d_attribut_de_personne0=new clAttribut("ta_nom","typeattribut",null);
...
var Types_d_attribut_Liste_des_types_d_attribut_de_personne0=new clEnsembleAttributs("typeattribut",
	new Array(
	new clLiaison(null,Col_N0_Libellé_De_Types_d_attribut_Liste_des_types_d_attribut_de_personne0)
	),
	new Array(
...
var Titre_Types_d_attribut_Liste_des_types_d_attribut_de_personne0=new Array("Libellé");
...
top.TAB_GLOBAL_COMPO[30]=Compo_Types_d_attribut_Libellé_1;
...
top.TAB_GLOBAL_COMPO[31]=Compo_Types_d_attribut_Catégories_2;
...
top.TAB_GLOBAL_COMPO[33]=Compo_Types_d_attribut_Libellé_3;
...
top.TAB_GLOBAL_COMPO[201]=Compo_Types_de_journaux_Libellé_1;
...
top.TAB_GLOBAL_COMPO[45]=Compo_Types_de_lien_Libellé_1;
...
top.TAB_GLOBAL_COMPO[49]=Compo_Types_de_personne_Libellé_1;
...
top.TAB_GLOBAL_COMPO[53]=Compo_Types_de_sociétés_Liste_des_types_de_sociétés0;
...
top.TAB_GLOBAL_COMPO[55]=Compo_Types_de_sociétés_Nom_1;
...
top.TAB_GLOBAL_COMPO[24]=Compo_Types_de_tâches_Liste_des_types_de_tâches0;
...
top.TAB_GLOBAL_COMPO[26]=Compo_Types_de_tâches_Libellé_1;
...
top.TAB_GLOBAL_COMPO[27]=Compo_Types_de_tâches_Description_2;
...
Filtre_Dep_Accès_0.setComposant(TAB_GLOBAL_COMPO[3],null);
   /* ARBRE DU DESSUS */
   var box=top.document.getElementById("ListeDessus_Adhérence_Périodes_de_validité_6");
   var Tab=ChercherCompo(box,"tree");
   var tree=Tab[0];
   tree.setAttribute("id","Tree_ListeDessus_Adhérence_Périodes_de_validité_6");
   tree.setAttribute("ondblclick","DoubleClic_ArbreDessus(document.getElementById('Tree_ListeDessus_Adhérence_Périodes_de_validité_6'), document.getElementById('Tree_ListeDessous_Adhérence_Périodes_de_validité_6'))");

   /* ARBRE DU DESSOUS */
   var box=top.document.getElementById("Adhérence_Périodes_de_validité_6");
   var Tab=ChercherCompo(box,"tree");
   var tree=Tab[0];
   tree.setAttribute("id","Tree_ListeDessous_Adhérence_Périodes_de_validité_6");
...
Filtre_DepFor_Employés_0.setComposant(TAB_GLOBAL_COMPO[77],null);
Filtre_Dep_Équipes_0.setComposant(TAB_GLOBAL_COMPO[120],null);
...
Filtre_Dep_Périodes_0.setComposant(TAB_GLOBAL_COMPO[194],null);
...
Filtre_Dep_Types_de_sociétés_0.setComposant(TAB_GLOBAL_COMPO[53],null);
