...
*/
 ...
 var Table="piece";
 var CleMaitre = TAB_COMPO_PPTES[66].NewCle;
 var NomCleMaitre = DePrefixerChamp(Compo_Maitre.getCle());
 var pi_libelle=GetValAt(72);
 if (!ValiderChampsObligatoire(Table,"pi_libelle",TAB_GLOBAL_COMPO[72],pi_libelle,false))
 	return -1;
 if (!ValiderChampsType(Table,"pi_libelle",TAB_GLOBAL_COMPO[72],pi_libelle))
 	return -1;
 var pi_date=GetValAt(73);
 if (!ValiderChampsObligatoire(Table,"pi_date",TAB_GLOBAL_COMPO[73],pi_date,false))
 	return -1;
 if (!ValiderChampsType(Table,"pi_date",TAB_GLOBAL_COMPO[73],pi_date))
 	return -1;
 var Req="insert into "+Table+" ";
var TabInsertionEnPlus=new Array();
var Asso11=false;
var TabAsso11=new Array();
var CompoLie = GetSQLCompoAt(59);
...
*/
 ...
 var cg_numero=GetValAt(81);
 if (cg_numero=="-1")
    cg_numero="null";
 if (!ValiderChampsObligatoire(Table,"cg_numero",TAB_GLOBAL_COMPO[81],cg_numero,true))
 	return -1;
 var ec_aux=GetValAt(82);
 if (!ValiderChampsObligatoire(Table,"ec_aux",TAB_GLOBAL_COMPO[82],ec_aux,false))
 	return -1;
 if (!ValiderChampsType(Table,"ec_aux",TAB_GLOBAL_COMPO[82],ec_aux))
 	return -1;
 var ca_numero=GetValAt(83);
 if (ca_numero=="-1")
    ca_numero="null";
 if (!ValiderChampsObligatoire(Table,"ca_numero",TAB_GLOBAL_COMPO[83],ca_numero,true))
 	return -1;
 var pf_numero=GetValAt(84);
 if (pf_numero=="-1")
    pf_numero="null";
 if (!ValiderChampsObligatoire(Table,"pf_numero",TAB_GLOBAL_COMPO[84],pf_numero,true))
 	return -1;
 var ec_libelle=GetValAt(85);
 if (!ValiderChampsObligatoire(Table,"ec_libelle",TAB_GLOBAL_COMPO[85],ec_libelle,false))
 	return -1;
 if (!ValiderChampsType(Table,"ec_libelle",TAB_GLOBAL_COMPO[85],ec_libelle))
 	return -1;
 var ec_debit=GetValAt(86);
 if (!ValiderChampsObligatoire(Table,"ec_debit",TAB_GLOBAL_COMPO[86],ec_debit,false))
 	return -1;
 if (!ValiderChampsType(Table,"ec_debit",TAB_GLOBAL_COMPO[86],ec_debit))
 	return -1;
 var ec_credit=GetValAt(87);
 if (!ValiderChampsObligatoire(Table,"ec_credit",TAB_GLOBAL_COMPO[87],ec_credit,false))
 	return -1;
 if (!ValiderChampsType(Table,"ec_credit",TAB_GLOBAL_COMPO[87],ec_credit))
 	return -1;
 var Req="insert into "+Table+" ";
var TabInsertionEnPlus=new Array();
 ...
 Req+=" values ("+CleMaitre+","+TAB_COMPO_PPTES[66].NewCle+","+cg_numero+","+(ec_aux=="true" ? "true" : "false")+","+ca_numero+","+pf_numero+","+(ec_libelle=="" ? "null" : "'"+ValiderChaine(ec_libelle)+"'" )+","+(ec_debit=="" ? "null" : "'"+ValiderChaine(ec_debit)+"'" )+","+(ec_credit=="" ? "null" : "'"+ValiderChaine(ec_credit)+"'" )+""+(TabInsertionEnPlus.length!=0?","+TabInsertionEnPlus[1]:"")+")";
...
*/
 ...
 var NomCleMaitre = DePrefixerChamp(Compo_Maitre.getCle());
 var cg_numcompte=GetValAt(104);
 if (!ValiderChampsObligatoire(Table,"cg_numcompte",TAB_GLOBAL_COMPO[104],cg_numcompte,false))
 	return -1;
 if (!ValiderChampsType(Table,"cg_numcompte",TAB_GLOBAL_COMPO[104],cg_numcompte))
 	return -1;
 var cg_libelle=GetValAt(105);
 if (!ValiderChampsObligatoire(Table,"cg_libelle",TAB_GLOBAL_COMPO[105],cg_libelle,false))
 	return -1;
 if (!ValiderChampsType(Table,"cg_libelle",TAB_GLOBAL_COMPO[105],cg_libelle))
 	return -1;
 var ac_numero=GetValAt(106);
 if (ac_numero=="-1")
    ac_numero="null";
 if (!ValiderChampsObligatoire(Table,"ac_numero",TAB_GLOBAL_COMPO[106],ac_numero,true))
 	return -1;
 var cg_accepteaux=GetValAt(107);
 if (!ValiderChampsObligatoire(Table,"cg_accepteaux",TAB_GLOBAL_COMPO[107],cg_accepteaux,false))
 	return -1;
 if (!ValiderChampsType(Table,"cg_accepteaux",TAB_GLOBAL_COMPO[107],cg_accepteaux))
 	return -1;
 var cg_utilisable=GetValAt(108);
 if (!ValiderChampsObligatoire(Table,"cg_utilisable",TAB_GLOBAL_COMPO[108],cg_utilisable,false))
 	return -1;
 if (!ValiderChampsType(Table,"cg_utilisable",TAB_GLOBAL_COMPO[108],cg_utilisable))
 	return -1;
 var cg_lettrable=GetValAt(109);
 if (!ValiderChampsObligatoire(Table,"cg_lettrable",TAB_GLOBAL_COMPO[109],cg_lettrable,false))
 	return -1;
 if (!ValiderChampsType(Table,"cg_lettrable",TAB_GLOBAL_COMPO[109],cg_lettrable))
 	return -1;
 var cg_pointable=GetValAt(110);
 if (!ValiderChampsObligatoire(Table,"cg_pointable",TAB_GLOBAL_COMPO[110],cg_pointable,false))
 	return -1;
 if (!ValiderChampsType(Table,"cg_pointable",TAB_GLOBAL_COMPO[110],cg_pointable))
 	return -1;
 var cg_groupable=GetValAt(111);
 if (!ValiderChampsObligatoire(Table,"cg_groupable",TAB_GLOBAL_COMPO[111],cg_groupable,false))
 	return -1;
 if (!ValiderChampsType(Table,"cg_groupable",TAB_GLOBAL_COMPO[111],cg_groupable))
 	return -1;
 var cg_debit=GetValAt(112);
 if (!ValiderChampsObligatoire(Table,"cg_debit",TAB_GLOBAL_COMPO[112],cg_debit,false))
 	return -1;
 if (!ValiderChampsType(Table,"cg_debit",TAB_GLOBAL_COMPO[112],cg_debit))
 	return -1;
 var Req="insert into "+Table+" ";
var TabInsertionEnPlus=new Array();
