...
var TAB_COMPO_PPTES = new Array(138);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[32].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[32].NewCle = getNewCle("exercice");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[32].ActiverComposant(false,true);
...
top.document.getElementById("Update_Exercice_Liste_des_exercices_comptables0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[32];
...
return TAB_COMPO_PPTES[32].NewCle;
}

function Delete_Exercice_Liste_des_exercices_comptables0()
{
 if (TAB_GLOBAL_COMPO[32].getCleVal()==-1)
 {
 ...
 {
	TAB_COMPO_PPTES[32].Action_en_cours = DELETE;
...
function Update_Exercice_Liste_des_exercices_comptables0()
{
 ...
 TAB_COMPO_PPTES[32].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[32].NewCle = TAB_GLOBAL_COMPO[32].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[32].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[35];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[32].Action_en_cours){
	case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[32].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[35];
...
top.document.getElementById("Update_Exercice_Liste_des_exercices_comptables0").disabled=false;
 if (NewCle==null)
 	NewCle=TAB_COMPO_PPTES[32].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[32].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[47].NewCle = getNewCle("journal");
/* On désactive le composant maitre */
...
/* On active les composants esclaves et on vide les champs */
 ...
 var Esclave_7=TAB_GLOBAL_COMPO[59];
...
if(TAB_COMPO_PPTES[47].Action_en_cours == INSERT)
{
...
{
 TAB_COMPO_PPTES[66].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[66].NewCle = getNewCle("piece");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[66].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[72];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[73];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Pièces_Écritures_3").disabled=false;
 var Esclave_2=TAB_GLOBAL_COMPO[74];
 Esclave_2.ActiverComposant(true);
...
top.document.getElementById("Update_Pièces_Liste_des_pièces_comptables0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[66];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[66].NewCle;
}

function Delete_Pièces_Liste_des_pièces_comptables0()
{
 if (TAB_GLOBAL_COMPO[66].getCleVal()==-1)
 {
 	alert("Vous devez selectionner l'enregistrement à suprimer");
 	return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
	TAB_COMPO_PPTES[66].Action_en_cours = DELETE;
...
function Update_Pièces_Liste_des_pièces_comptables0()
{
 ...
 TAB_COMPO_PPTES[66].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[66].NewCle = TAB_GLOBAL_COMPO[66].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[66].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[72];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[66].Action_en_cours){
	case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[66].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[72];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[73];
...
top.document.getElementById("Update_Pièces_Liste_des_pièces_comptables0").disabled=false;
 if (NewCle==null)
 	NewCle=TAB_COMPO_PPTES[66].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 ...
 TAB_COMPO_PPTES[66].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[66].Action_en_cours == INSERT)
 	{
 		if (confirm("Pour continuer, vous devez enregistrer votre saisie\n Voulez vous poursuivre ?"))
		{
 ...
 TAB_COMPO_PPTES[74].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[74].NewCle = getNewCle("ecriture");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[74].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
...
top.document.getElementById("Delete_Pièces_Écritures_3").disabled=true;
top.document.getElementById("Update_Pièces_Écritures_3").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[74];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
TAB_GLOBAL_COMPO[86].my_CompoXUL.value="0.00";
TAB_GLOBAL_COMPO[87].my_CompoXUL.value="0.00";

return TAB_COMPO_PPTES[74].NewCle;
}

function Delete_Pièces_Écritures_3()
{
 if (TAB_GLOBAL_COMPO[74].getCleVal()==-1)
 {
 	alert("Vous devez selectionner l'enregistrement à suprimer");
 	return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
	TAB_COMPO_PPTES[74].Action_en_cours = DELETE;
...
function Update_Pièces_Écritures_3()
{
 ...
 TAB_COMPO_PPTES[74].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[74].NewCle = TAB_GLOBAL_COMPO[74].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[74].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[81];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[74].Action_en_cours){
	case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[74].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[81];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[82];
...
top.document.getElementById("Update_Pièces_Écritures_3").disabled=false;
 if (NewCle==null)
 	NewCle=TAB_COMPO_PPTES[74].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[74].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[88].NewCle = getNewCle("ecriture");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[88].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[93];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[94];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[95];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[96];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[97];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[98];
 Esclave_5.ActiverComposant(true);
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[99].NewCle = getNewCle("comptegen");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[99].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[104];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[105];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[106];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[107];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[108];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[109];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[110];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[111];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[112];
 Esclave_8.ActiverComposant(true);
 var Esclave_9=TAB_GLOBAL_COMPO[113];
 Esclave_9.ActiverComposant(true);
 var Esclave_10=TAB_GLOBAL_COMPO[117];
...
{
/* Pour les filtrage fort on ne doit pas être en mode insertion */
if(TAB_COMPO_PPTES[99].Action_en_cours == INSERT)
{
	if (confirm("Pour continuer, vous devez enregistrer votre saisie\n Voulez vous poursuivre ?"))
	{
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[123].NewCle = getNewCle("compteaux");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[123].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[128];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[129];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[130];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[131];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[132];
 Esclave_4.ActiverComposant(true);
...
function gestsea_comptabilite_Chargement()
{
pgsql_init(true);
...
top.TAB_GLOBAL_COMPO[32]=Compo_Exercice_Liste_des_exercices_comptables0;
...
top.TAB_GLOBAL_COMPO[35]=Compo_Exercice_Du_1;
...
top.TAB_GLOBAL_COMPO[36]=Compo_Exercice_Au_2;
...
top.TAB_GLOBAL_COMPO[37]=Compo_Exercice_Clôturé_3;
...
top.TAB_GLOBAL_COMPO[38]=Compo_Exercice_Compte_d_attente_4;
...
top.TAB_GLOBAL_COMPO[39]=Compo_Exercice_Exercice_en_cours_5;
...
top.TAB_GLOBAL_COMPO[40]=Compo_Exercice_Pièces_de_l_exercice_6;
...
top.TAB_GLOBAL_COMPO[47]=Compo_Journaux_Liste_des_journaux0;
...
top.TAB_GLOBAL_COMPO[52]=Compo_Journaux_Type_de_journal_1;
...
top.TAB_GLOBAL_COMPO[53]=Compo_Journaux_Abbréviation_2;
...
top.TAB_GLOBAL_COMPO[54]=Compo_Journaux_Libellé_3;
...
top.TAB_GLOBAL_COMPO[55]=Compo_Journaux_Provisoire_4;
...
top.TAB_GLOBAL_COMPO[56]=Compo_Journaux_Visible_5;
...
top.TAB_GLOBAL_COMPO[57]=Compo_Journaux_Contrepartie_6;
...
top.TAB_GLOBAL_COMPO[58]=Compo_Journaux_Compte_de_la_contrepartie_7;
...
top.TAB_GLOBAL_COMPO[59]=Compo_Journaux_Pièces_comptables_8;
...
top.TAB_GLOBAL_COMPO[66]=Compo_Pièces_Liste_des_pièces_comptables0;
...
top.TAB_GLOBAL_COMPO[72]=Compo_Pièces_Libellé_1;
...
top.TAB_GLOBAL_COMPO[73]=Compo_Pièces_Date_2;
...
top.TAB_GLOBAL_COMPO[74]=Compo_Pièces_Écritures_3;
...
top.TAB_GLOBAL_COMPO[81]=Compo_Pièces_Compte_général_4;
...
top.TAB_GLOBAL_COMPO[82]=Compo_Pièces_Ecriture_sur_compte_auxiliaire_5;
...
top.TAB_GLOBAL_COMPO[83]=Compo_Pièces_Compte_auxiliaire_6;
...
top.TAB_GLOBAL_COMPO[84]=Compo_Pièces_Préfixe_7;
...
top.TAB_GLOBAL_COMPO[85]=Compo_Pièces_Libellé_8;
...
top.TAB_GLOBAL_COMPO[86]=Compo_Pièces_Débit_9;
...
top.TAB_GLOBAL_COMPO[87]=Compo_Pièces_Crédit_10;
...
top.TAB_GLOBAL_COMPO[88]=Compo_Ecritures_Liste_des_écritures_comptables0;
...
top.TAB_GLOBAL_COMPO[93]=Compo_Ecritures_Libellé_1;
...
top.TAB_GLOBAL_COMPO[94]=Compo_Ecritures_Compte_2;
...
top.TAB_GLOBAL_COMPO[95]=Compo_Ecritures_Débit_3;
...
top.TAB_GLOBAL_COMPO[96]=Compo_Ecritures_Crédit_4;
...
top.TAB_GLOBAL_COMPO[97]=Compo_Ecritures_Pointage_5;
...
top.TAB_GLOBAL_COMPO[98]=Compo_Ecritures_Lettrage_6;
...
top.TAB_GLOBAL_COMPO[99]=Compo_Comptes_généraux_Liste_des_comptes_généraux0;
...
top.TAB_GLOBAL_COMPO[104]=Compo_Comptes_généraux_Numéro_de_compte_1;
...
top.TAB_GLOBAL_COMPO[105]=Compo_Comptes_généraux_Libellé_2;
...
top.TAB_GLOBAL_COMPO[106]=Compo_Comptes_généraux_Niveau_d_accès_3;
...
top.TAB_GLOBAL_COMPO[107]=Compo_Comptes_généraux_Le_compte_peut_avoir_des_compte_auxiliaires_4;
...
top.TAB_GLOBAL_COMPO[108]=Compo_Comptes_généraux_Le_compte_est_utilisable_5;
...
top.TAB_GLOBAL_COMPO[109]=Compo_Comptes_généraux_Le_compte_est_lettrable_6;
...
top.TAB_GLOBAL_COMPO[110]=Compo_Comptes_généraux_Le_compte_est_pointable_7;
...
top.TAB_GLOBAL_COMPO[111]=Compo_Comptes_généraux_Le_compte_est_groupable_8;
...
top.TAB_GLOBAL_COMPO[112]=Compo_Comptes_généraux_Le_compte_est_un_débit_9;
...
top.TAB_GLOBAL_COMPO[113]=Compo_Comptes_généraux_Comptes_auxiliaires_10;
...
top.TAB_GLOBAL_COMPO[117]=Compo_Comptes_généraux_Ecriture_11;
...
top.TAB_GLOBAL_COMPO[123]=Compo_Comptes_auxiliaires_Liste_des_comptes_auxiliaires0;
...
top.TAB_GLOBAL_COMPO[128]=Compo_Comptes_auxiliaires_Numéro_de_compte_1;
...
top.TAB_GLOBAL_COMPO[129]=Compo_Comptes_auxiliaires_Libellé_2;
...
top.TAB_GLOBAL_COMPO[130]=Compo_Comptes_auxiliaires_Niveau_d_accès_3;
...
top.TAB_GLOBAL_COMPO[131]=Compo_Comptes_auxiliaires_Le_compte_est_un_débit_4;
...
top.TAB_GLOBAL_COMPO[132]=Compo_Comptes_auxiliaires_Ecriture_5;
Filtre_DepFor_Pièces_0.setComposant(TAB_GLOBAL_COMPO[66],null);
Filtre_DepFor_Pièces_1.setComposant(TAB_GLOBAL_COMPO[66],null);
Filtre_DepFor_Ecritures_0.setComposant(TAB_GLOBAL_COMPO[88],null);
Filtre_DepFor_Ecritures_1.setComposant(TAB_GLOBAL_COMPO[88],null);
Filtre_DepFor_Ecritures_2.setComposant(TAB_GLOBAL_COMPO[88],null);
Filtre_DepFor_Comptes_auxiliaires_0.setComposant(TAB_GLOBAL_COMPO[123],null);
 if(ALeDroit(5,"exercice"))
 {
/* On refresh les composants non dépendents de l'onget Exercice*/
var Composant_0 = TAB_GLOBAL_COMPO[32];
if (Composant_0!=null){
...
var Composant_0 = TAB_GLOBAL_COMPO[66];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
