...
function tps_activite_display() {
	...
	enumer.first();
	selectRow("tache-menulist", enumer.getVariant(i++));
	selectRow("theme-menulist", enumer.getVariant(i++));
	selectRow("sujet-menulist", enumer.getVariant(i++));
	selectRow("lieu-menulist",  enumer.getVariant(i++));
	elem("pour-radiogroup").selectedIndex = enumer.getVariant(i++);
	var qui = elem("pour-radiogroup").selectedIndex;
	if (qui<3) elem("pour-textbox").value = enumer.getVariant(i++);
	else selectRow("groupe-menulist",  enumer.getVariant(i++));
	/*
	...
	*/
	elem("de-textbox").value = cleanTime(enumer.getVariant(i++));
	elem("a-textbox").value = cleanTime(enumer.getVariant(i++));
	elem("duree-textbox").value = enumer.getVariant(i++);
