...
const GEN_PATH = "chrome://agrisig/content/agrisig/lib/";
const LIMIT = 50;
...
/*
  ...
  include pgsql.js
  include generateur_interface_sql.js
  include pointer.js
*/
...
clAddon_FiltreTotal.prototype.OnClick =
    function()
{
    this.my_ComposantSQL.my_ReqRefresh.setFiltrageTotal(this.mes_ComposXUL[0].checked)
...
clCompoTextBox.prototype.GenererCompoXUL =
	...
	hbox = mydoc.createElement("hbox");
	if (this.MultiLine) hbox.setAttribute("align","start");
	else hbox.setAttribute("align","center");
	hbox.setAttribute("flex","1");
	hbox.setAttribute("equalsize","always");
	//hbox.setAttribute("style","padding:10px; border:2px solid yellow");
	ParentXul.appendChild(hbox);
...
clCompoCheckBox.prototype.GenererCompoXUL =
	...
	checkbox.setAttribute("oncommand","GetVar("+ref+").OnChange();");
	ParentXul.appendChild(checkbox);
...
clCompoListe.prototype.GenererCompoXUL =
	...
	for(i=0;i<this.TabNomsCols.length;i++)
	{
	    ...
	    treecol.setAttribute("flex","1");
	    //		treecol.setAttribute("persist","hidden");
