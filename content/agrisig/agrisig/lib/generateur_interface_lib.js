	    ...
	    if (TabStrOnglets.length!=0)
		{
		    ...
		    else
			{
			    ...
			    if (TabStrOnglets.length>=max_onglets) CodeSlaves+='<hbox style="overflow: auto;">\n'
								       CodeSlaves+='<tabs ';
			    if (TabStrOnglets.length>=max_onglets) CodeSlaves+='height="40"';
			    CodeSlaves+='>\n';
...
clInterfaceSimple.prototype.GenererInterfaceXulPanel=function()
{
	...
	if (this.Dependant)
	{
	    ...
	    StrXul+='    <button minwidth="150" label="Retour" oncommand="Retour_'+NomOnglet+'()"/>\n';
	    StrXul+='  </hbox>\n';
	}
	StrXul+='</hbox>\n';
	//StrXul+='</groupbox>\n';
    ...
    function(MonNomFichier,overlay,TitreFenetre,AutoSave)
{
    ...
    /*    if (overlay)
    StrXul+='<script src="chrome://agrisig/content/agrisig/bin/'+MonNomFichier+'.js"/>\n';
    ...
    */
    ...
    if (this.mes_interfaces.length>8) StrXul+=' style="overflow: auto;" ';
    StrXul+='>\n';
    ...
    if (this.mes_interfaces.length>8) StrXul+=' height="36" ';    
    StrXul+='>\n'; // height="36"
