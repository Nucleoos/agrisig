...
function pgsql_init(methode) {
  ...
  if (methode)
    ...
    var sb_infobdd = top.document.getElementById("infobdd");
    if (sb_infobdd!=null)
	{
	    sb_infobdd.setAttribute("label","BDD : Connectée");
	}
...
function pgsql_deco() {
  ...
  var sb_infobdd = top.document.getElementById("infobdd");
  sb_infobdd.setAttribute("label","BDD : Déconnectée");
