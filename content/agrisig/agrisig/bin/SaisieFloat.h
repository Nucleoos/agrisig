...
function DialogueFlottants(titre,fonction,LesChampFlottant)
{
    var Parametres=DialogueFlottants.arguments;
     window.openDialog("SaisieFloat.xul", "showmore", "chrome,scrollbars,resizable",Parametres);
}